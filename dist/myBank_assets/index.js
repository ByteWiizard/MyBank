...
/***/ "./src/declarations/myBank/index.js":
/*!******************************************!*\
  !*** ./src/declarations/myBank/index.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   idlFactory: () => (/* reexport safe */ _myBank_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   myBank: () => (/* binding */ myBank)
/* harmony export */ });
...
/* harmony import */ var _myBank_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./myBank.did.js */ "./src/declarations/myBank/myBank.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./myBank.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_myBank_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the myBank canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./myBank.did.js")._SERVICE>}
 */
 const myBank = createActor(canisterId);


/***/ }),

/***/ "./src/declarations/myBank/myBank.did.js":
/*!***********************************************!*\
  !*** ./src/declarations/myBank/myBank.did.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!****************************************!*\
  !*** ./src/myBank_assets/src/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_myBank__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/myBank */ "./src/declarations/myBank/index.js");


window.addEventListener("load", async function () {
  const currentAmount = await _declarations_myBank__WEBPACK_IMPORTED_MODULE_0__.myBank.checkBalance();
...
document.querySelector("form").addEventListener("submit", async function (event) {
  ...
  try {
    if (inputAmount > 0) {
      await _declarations_myBank__WEBPACK_IMPORTED_MODULE_0__.myBank.topUp(inputAmount);
    }
    if (outputAmount > 0) {
      await _declarations_myBank__WEBPACK_IMPORTED_MODULE_0__.myBank.withdrawl(outputAmount);
    }
    await _declarations_myBank__WEBPACK_IMPORTED_MODULE_0__.myBank.compound();
  } catch (error) {
